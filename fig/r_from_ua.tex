...
\begin{document}
\pgfplotstableset{
	create on use/R/.style={
	    create col/expr={ 
	    1000/\thisrow{uout}*2.5
	    }
	},
...
\pgfplotstablesave[
	...
	\begin{tikzpicture}
	  ...
	  %          {$\pgfmathprintnumber[frac, frac denom=32,frac whole=false]{\pgfmathresult}\pi$}
		...
		\addplot +[mark=*, line width=0.3pt, mark size=1.3pt,solid,blue] plot [error bars/.cd, y dir = both, y fixed=0] table [ x=ua, y=R,] {../data/2av_.tsv};
