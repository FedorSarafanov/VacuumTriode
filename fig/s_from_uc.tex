...
\begin{document}
\pgfplotstableset{
	create on use/s/.style={
	    create col/expr={
	    \thisrow{uout}/300*1/2.5/1000
	    }
	},
...
\pgfplotstablesave[
	...
	\begin{tikzpicture}
	  ...
	  %          {$\pgfmathprintnumber[frac, frac denom=32,frac whole=false]{\pgfmathresult}\pi$}
		...
		\addplot +[mark=*, line width=0.3pt, mark size=1.3pt,solid,blue] plot [error bars/.cd, y dir = both, y fixed=0] table [ x=muc, y=s,] {../data/1a.tsv};
