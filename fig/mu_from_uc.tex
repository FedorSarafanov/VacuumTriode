...
\pgfplotstablesave[
	...
	\begin{tikzpicture}
	  ...
	  %          {$\pgfmathprintnumber[frac, frac denom=32,frac whole=false]{\pgfmathresult}\pi$}
		...
		\addplot +[mark=*, line width=0.3pt, mark size=1.3pt,solid,blue] plot [error bars/.cd, y dir = both, y fixed=0] table [ x=uc, y=mu,] {uc_mu.tsv};
		\addlegendentry{$u_\text{a}=220$ В}
