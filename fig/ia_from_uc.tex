...
\pgfplotstableset{
	...
	\begin{tikzpicture}
	  ...
	  %          {$\pgfmathprintnumber[frac, frac denom=32,frac whole=false]{\pgfmathresult}\pi$}
		...
		\addplot +[mark=*, line width=0.3pt, mark size=1.3pt,solid,blue] plot [error bars/.cd, y dir = both, y fixed=0] table [ x=muc, y=ia,] {../data/1a.tsv};
		\addlegendentry{$u_\text{а}=220$ В}
		\addplot +[mark=*, line width=0.3pt, mark size=1.3pt,solid,red] plot [error bars/.cd, y dir = both, y fixed=0] table [ x=muc, y=ia,] {../data/1b.tsv};
		\addlegendentry{$u_\text{а}=150$ В}
